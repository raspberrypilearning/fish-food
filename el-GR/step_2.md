...
![Δημιουργία έργου](images/create-project.png)

Θα πρέπει τώρα να δεις την επιλογή «Τροφή για ψάρια» στη λίστα έργων. Κάνε κλικ στο έργο.
![Λίστα έργων με τροφή για ψάρια.](images/projects-list.png)
...
![Κύριο μενού έργου με ένα βέλος που δείχνει προς το κουμπί Εκπαίδευση.](images/project-train.png)
...
![Αναδυόμενο μήνυμα που ζητά να επιτραπεί η χρήση του μικροφώνου.](images/allow-microphone.png)
